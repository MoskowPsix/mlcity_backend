...
return [
    ...
    'organization' => [
        'transfer_user' => [
            'success' => 'Пользователь успешно переведен',
            'not_permission' => 'Вы не имеете право передавать эту организацию',
            'not_found' => 'Пользователь или организация не найдены',
        ],
        'created' => [
    ...
    'event' => [
        ...
        'event_user_liked_ids' => [
            'success' => 'Пользователи лайкнувшие события получены'
        ],
        'event_user_favorites_ids' => [
            'success' => 'Пользователи добавившие событие в избранное получены',
        ],
    ...
    'notify' => [
        'private' => [
            'event' => [
                'started_day' => 'Событие начнётся в течении суток'
            ],
        ],
    ],
];
