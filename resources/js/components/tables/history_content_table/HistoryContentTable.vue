        ...
        >
            ...
            <tbody>
                <tr
                    ...
                    :key="content.id"
                    class="transition bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer active:scale-95"
                    @click.prevent="clickContent(content)"
                >
                    <th
                        scope="row"
                    ...
                    <td class="px-6 py-4">
                        <div class="flex justify-between">
                            <svg
                                v-if="
                                    content.history_contentable_type ===
                                    'App\\Models\\Event'
                                "
                                aria-hidden="true"
                    ...
                    <td class="px-6 py-4">
                        <h1 class="dark:text-gray-200 text-base"
                            >{{ content.user.id }} / {{ content.user.name }}</h1
                        >
