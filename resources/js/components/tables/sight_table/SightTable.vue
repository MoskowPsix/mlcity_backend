...
<div class="relative z-10 overflow-x-auto border border-gray-300 dark:border-gray-700 dark:border-gra rounded-lg">
    <table class="border border-gray-300 dark:border-gray-700 rounded-lg w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr class="transition active:scale-95 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer" v-for="sight in sights" @click.prevent="emitEvent(sight)">
                ...
                <td class="px-6 py-4">
                    <h1 class="dark:text-gray-200 text-base">{{sight.author.id}} / {{sight.author.name}}</h1>
                        <p class="dark:text-gray-400 text-ml">{{sight.author.email}}</p>
                </td>
                <td class="px-6 py-4">
                    {{sight.address}}
                </td>
