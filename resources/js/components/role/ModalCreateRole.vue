...
export default defineComponent({
    ...
    methods: {
        closeModal() {
            this.store_role.closeCreateModal();
        },
        createRole(name) {
            this.store_role.createRole(name);
            this.name = '';
        }
    } 
})
            ...
            <div
                ...
                <div class="modal-content py-6 text-left px-6 ">
                    ...
                    <div class="flex justify-between items-center pb-3">
                        <p class="text-2xl font-bold text-gray-300">Создать роль</p>
                    ...
                    <div class="flex justify-end pt-2">
                        ...
                        <button @click="createRole(role_name)" class="focus:outline-none px-4 bg-teal-500 p-3 ml-3 rounded-lg text-white hover:bg-teal-400">Создать</button>
                    </div>
                </div>
            </div>
        </div>
