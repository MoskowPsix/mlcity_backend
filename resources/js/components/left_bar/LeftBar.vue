<template>
    ...
    >
        <div
            class="h-full px-5 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800"
        >
            <!-- <a :href="urlFront">
         <button type="button" class="w-full flex items-center justify-center m-2 mx-auto px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto dark:hover:bg-gray-900 dark:bg-gray-800 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700/50">
            ...
            >
                ...
                <span
                    ...
                    >MyLittleCity<p class="text-xs items-center"
                        >{{ role }}Panel</p
                    ></span
                >
                <div class="flex flex-row justify-between toggle mx-10">
                    <label class="flex items-center cursor-pointer">
                        <div class="relative">
                            ...
                            />
                            <div
                                class="block border-[1px] dark:border-white border-gray-900 w-8 h-5 rounded-full"
                            ></div>
                            <div
                                class="dot absolute left-1 top-1 dark:bg-white bg-gray-800 w-3 h-3 rounded-full transition"
                            ></div>
                        </div>
                    </label>
                </div>
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    ...
                    >
                        <svg
                            aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white enable-background:new 0 0 24 24"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                ...
                >
                    ...
                    >
                        <svg
                            aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-green-400 group-hover:text-gray-900 dark:group-hover:text-white enable-background:new 0 0 24 24"
                            fill="currentColor"
                            viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                ...
                >
                    ...
                    >
                        <svg
                            aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-green-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor"
                            viewBox="0 0 500 600"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                ...
                >
                    ...
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-orange-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                        >
                            <path
               ...
               <span class="flex-1 ml-3 whitespace-nowrap">Роли</span>
                ...
                <!-- <li v-if="role == 'Admin' || role == 'root'">
                    ...
                    >
                        <svg
                            fill="currentColor"
                            class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-blue-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                            <g>
                                <path
                                    d="M69.897,265.767h260.206c1.822,0,3.509-0.958,4.442-2.522c0.934-1.564,0.976-3.505,0.111-5.107l-63.683-118.042
                        ...
                        l16.339-16.339l8.815,16.339H275.474z"
                                />
                                <path
                                    d="M148.43,120.198h103.14c1.822,0,3.509-0.958,4.442-2.521c0.933-1.564,0.975-3.505,0.11-5.109l-51.57-95.588
                        ...
                        C144.921,119.24,146.608,120.198,148.43,120.198z"
                                />
                                <path
                                    d="M399.379,378.108l-49.872-92.444c-0.903-1.673-2.651-2.716-4.553-2.716H55.046c-1.901,0-3.65,1.043-4.553,2.716
                ...
                <li v-if="role == 'Admin' || role == 'root'">
                    ...
                    >
                        <svg
                            aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-yellow-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                ...
                <li v-if="role == 'root'">
                    ...
                    >
                        <svg
                            aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-red-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            fill="currentColor"
                            viewBox="0 0 17 17"
                            xmlns="http://www.w3.org/2000/svg"
                        >
