<template lang="">
    <div
    v-bind:class="{'border-blue-700/70': this.$props.changedPlaceIds != null && this.$props.changedPlaceIds.includes(place.id)}"
    class=" transition border dark:border-gray-700/80 p-2 rounded-lg mt-12 dark:bg-gray-800 active:dark:bg-gray-700 active:bg-gray-300 shadow-md">
