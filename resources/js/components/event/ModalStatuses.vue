...
<div class="main-modal fixed w-full h-100 inset-0 z-50 overflow-hidden flex justify-center items-center animated fadeIn faster" style="background: rgba(0,0,0,.5);">
        ...
        <label for="status" class="leading-7 px-5 text-sm text-gray-700 dark:text-gray-400" v-if="event_store.event.statuses.length !== 0">Текущий тип мероприятия: {{ event_store.event.statuses[0].name }}</label>
