    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="grid grid-cols-2 gap-2 rounded">
            ...
            <div class=" rounded border border-gray-600 dark:border-gray-500 bg-gray-300 dark:bg-gray-800 px-5 text-gray-200 items-center"> 
                <h1 class="px-2 text-gray-600 text-sm dark:text-gray-200">Статус</h1>
                    <select v-model="event_store.event_search.status" class="bg-gray-300 dark:bg-gray-800 w-10/12 text-gray-600 dark:text-gray-200 focus:outline-none">
            ...
            <div class="flex rounded border border-gray-600 dark:border-gray-500 bg-gray-300 dark:bg-gray-800 px-5 text-gray-200 items-center"> 
                <h1 class="px-2 text-gray-600 dark:text-gray-200 text-sm">Тип события
                <select v-model="event_store.event_search.types" class="bg-gray-300 dark:bg-gray-800 w-10/12 text-gray-600 dark:text-gray-200 max-w-full focus:outline-none">
        ...
        <div class="grid grid-cols-2 gap-2 rounded">
            ...
            <input type="text" v-model="event_store.event_search.author" placeholder="Имя или почта автора"
                class="rounded my-6 px-5 bg-gray-300 dark:bg-gray-800 text-gray-600 dark:text-gray-200  max-w-full focus:outline-none "/>
        ...
        <div class="flex justify-center text-gray-400 dark:text-gray-200">
            <button v-on:click="event_store.getEventSearch()" class="p-2 w-1/4 rounded-md dark:bg-blue-800 dark:hover:bg-blue-700 text-blue-100 bg-blue-600 hover:bg-blue-500">
                Найти
            </button>
        </div>
        <div class=" text-gray-400 dark:text-gray-200">
            <button v-on:click="event_store.clearSearch()" class="px-1 rounded-md dark:bg-green-800 text-green-100 dark:hover:bg-green-700 bg-green-600 hover:bg-green-500">
                Сбросить фильтры
            </button>
        </div>
</div>
