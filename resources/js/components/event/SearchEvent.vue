...
<div class="border border-gray-300 dark:border-gray-800 p-6 grid grid-cols-1 gap-6 dark:bg-gray-700 shadow-lg rounded-lg">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="grid grid-cols-2 gap-2 rounded">
            ...
            <div class=" rounded  bg-gray-300 dark:bg-gray-800 p-1 px-5 text-gray-200 items-center"> 
                <h1 class="px-2 text-gray-400 dark:text-gray-200">Статус:
                    <select v-model="event_store.event_search.status" class="bg-gray-300 dark:bg-gray-800 text-gray-600 dark:text-gray-200 max-w-full focus:outline-none">
            ...
            <div class="flex rounded bg-gray-300 dark:bg-gray-800 p-1 px-5 text-gray-200 items-center"> 
                ...
                <select v-model="event_store.event_search.types" class="bg-gray-300 dark:bg-gray-800 text-gray-600 dark:text-gray-200 max-w-full focus:outline-none">
        ...
        <div class="grid grid-cols-2 gap-2 rounded">
            ...
            <VueTailwindDatepicker class="py-1" v-model="event_store.event_search.date" placeholder="Временные рамки" />
        ...
        <div class="flex justify-center text-gray-400 dark:text-gray-200">
            <button v-on:click="event_store.getEventSearch()" class="p-2 w-1/4 rounded-md dark:bg-blue-800 text-blue-100 bg-blue-600 hover:bg-blue-500">
                Найти
            </button>
        </div>
