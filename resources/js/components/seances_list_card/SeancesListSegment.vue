<template lang="">
    <div
    @click="clickElement"
    class=" dark:border-gray-700  dark:bg-gray-900/40   border-gray-500/30 rounded-lg  lg:max-w-[90%] lg:ml-[auto] mr-[auto] mb-8 lg:pl-8 lg:pr-8 lg:pb-4 lg:pt-4">
    <div @click="clickElement" class="bg-gray-900/5  dark:border-gray-700 dark:bg-gray-900/40   border-gray-500/30 rounded-lg  lg:max-w-[90%] lg:ml-[auto] mr-[auto] mb-8 lg:pl-8 lg:pr-8 lg:pb-4 lg:pt-4">
