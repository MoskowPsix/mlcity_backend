<template lang="">
    <div v-bind:class="{'border-blue-700/70 border rounded-lg':this.$props.changedSeanceIds != null && this.$props.changedSeanceIds.includes(seance.id), 'border-green-600 border rounded-lg':seance.new != null && seance.new, 'border-red-600 border rounded-lg':seance.delete}" @click="clickElement" class="bg-gray-900/5  dark:border-gray-700 dark:bg-gray-900/40    rounded-lg  lg:max-w-[90%] lg:ml-[auto] mr-[auto] mb-8 lg:pl-8 lg:pr-8 lg:pb-4 lg:pt-4">
        <div @click.prevent="setDelete" class="h-5 w-5 dark:bg-red-900 ml-[95%] dark:text-red-500  bg-red-400 text-red-800 cursor-pointer rounded-lg" v-if="state">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" data-slot="icon" class="w-2 h-4  mx-auto my-auto">
