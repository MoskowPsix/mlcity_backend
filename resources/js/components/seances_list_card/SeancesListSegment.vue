<template lang="">
    <div v-bind:class="{'border-blue-700/70 border rounded-lg':this.$props.changedSeanceIds != null && this.$props.changedSeanceIds.includes(seance.id), 'border-green-600 border rounded-lg':seance.new != null && seance.new}" @click="clickElement" class="bg-gray-900/5  dark:border-gray-700 dark:bg-gray-900/40    rounded-lg  lg:max-w-[90%] lg:ml-[auto] mr-[auto] mb-8 lg:pl-8 lg:pr-8 lg:pb-4 lg:pt-4">
