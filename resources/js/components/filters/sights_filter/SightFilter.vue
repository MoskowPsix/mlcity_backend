<template lang="">
    <div>
        <div class="border dark:bg-gray-800 bg-gray-200 border-gray-300 dark:border-gray-700 shadow rounded grid grid-cols-3 gap-6 p-6 dark:text-gray-300">
        <input v-model="sightName" type="text" name="name" id="name" placeholder="Название" class=" rounded-lg dark:bg-gray-800 dark:border-gray-700 border-gray-400/50">
        <input v-model="sightSponsor" type="text" name="sponsor" id="sponsor" placeholder="Спонсор мероприятия" class=" rounded-lg dark:bg-gray-800 dark:border-gray-700 border-gray-400/50">
        <input v-model="sightText" type="text" name="text" id="text" placeholder="Поиск по тексту" class=" rounded-lg dark:bg-gray-800 dark:border-gray-700 border-gray-400/50">
        <div class="flex border p-1 rounded-lg dark:bg-gray-800 dark:border-gray-700 border-gray-400/50">
            <div>
                <select class="h-6" v-model="sightStatuses" data-te-select-init>
        ...
        <input v-model="sightUser" type="text" name="user" id="user" placeholder="Имя или почта автора" class=" rounded-lg dark:bg-gray-800 dark:border-gray-700 border-gray-400/50">
