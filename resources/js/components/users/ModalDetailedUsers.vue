        ...
        <div class="flex h-screen w-full flex-col items-center justify-center gap-y-2">
            <div class="w-[500px] rounded-xl border border-gray-200 dark:border-gray-600 dark:bg-gray-800 bg-white py-4 px-2 shadow-md shadow-gray-600">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex max-h-[400px] w-full flex-col overflow-y-auto overflow-gray-900 l" id="journal-scroll" v-if="user_store.menu_user_loader === false" v-for="item in user_store.events_sights_user.data" :key="item.id">
                        <button class="group flex items-center gap-x-5 rounded-md px-2.5 py-2 my-0.5 transition-all duration-75 bg-gray-200 dark:bg-gray-700 hover:bg-green-100 dark:bg-gray-700 dark:hover:bg-green-700 rounded-xl">
