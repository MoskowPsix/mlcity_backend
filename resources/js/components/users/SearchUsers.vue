...
export default {
    ...
    setup: () => {
        ...
        const user_email = '';
        const time = '';
        return {user_name, user_email, time, user_store}
    },
    methods: {
        clear() {
        this.user_email = '';
                        ...
                        <div class="grid grid-cols-2 gap-2 rounded">
                            <div class="flex rounded bg-gray-200 dark:bg-gray-800 items-center p-2 ">
                                ...
                                <input type="text" v-model="user_name" placeholder="Название мероприятия..."
                                       class=" bg-gray-200 dark:bg-gray-800 text-gray-200  dark:text-gray-200 max-w-full focus:outline-none text-gray-700"/>
                            </div>
                            <div class="flex rounded bg-gray-200 dark:bg-gray-800 items-center p-2 ">
