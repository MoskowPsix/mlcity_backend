        ...
        methods: {
                    ...
                    .pipe(
                        map((response) => {
                            ...
                            response.data.user.roles[0]
                                ? this.setRole(response.data.user.roles[0].name)
                                : null
            ...
            loginByToken() {
                if (this.$route.params.token.length >= 47) {
                    this.openLoaderFullPage()
                    this.setToken(
                        JSON.parse(JSON.stringify(this.$route.params.token)),
                    )
                    this.setTimeZone(
            ...
            >
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    >
                        ...
                        <button
                            class="w-full dark:text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
