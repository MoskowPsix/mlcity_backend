                ...
                <div class="flex items-center justify-center min-w-[100%] flex-col m-2 p-5">
                    <div class="w-[100%] xl:w-[80%] text-xs lg:text-lg">
                        ...
                        <div class="grid lg:grid-cols-2 mt-4">
                            ...
                            <!-- Расписание достопримечательности -->
                            <div>
                        ...
                        <div class="mt-4 mb-8">
                            <label class="font-[Montserrat-Regular] text-xs lg:text-lg">Адрес</label>
                        ...
                        <!-- Материалы достопримечательности -->
